...
const translations = {
  ...
  'EMDAD ENGINEERING SOLUTIONS': 'إمداد للحلول الهندسية',
  'Search company, project, contact...': 'ابحث عن شركة أو مشروع أو جهة اتصال...',
  'Executive Sales Overview': 'نظرة تنفيذية على المبيعات',
  'My Sales Workspace': 'مساحة عمل المبيعات الخاصة بي',
  ...
  'Expected Pipeline': 'قيمة الـ Pipeline المتوقعة',
  'Contract Value': 'قيمة العقود',
  'Collected': 'المحصل',
  'Overdue Follow-ups': 'المتابعات المتأخرة',
  'Due Today': 'مستحق اليوم',
  'Attention required': 'يحتاج إلى إجراء',
  'Next actions for the team': 'الإجراءات التالية للفريق',
  'Open follow-ups →': 'فتح المتابعات ←',
  'Customer/project actions that need attention': 'إجراءات العملاء والمشروعات التي تحتاج إلى متابعة',
  'Team': 'الفريق',
  'Active sales employees': 'موظفو المبيعات النشطون',
  'View team →': 'عرض الفريق ←',
  'No employees yet.': 'لا يوجد موظفون حتى الآن.',
  'No records found': 'لا توجد بيانات',
  'Each project has one responsible employee.': 'لكل مشروع موظف مسؤول واحد فقط.',
  '+ New Project': '+ مشروع جديد',
  '+ New Company': '+ شركة جديدة',
  '+ New Contact': '+ جهة اتصال جديدة',
  '+ New Follow-up': '+ متابعة جديدة',
  '+ Add Employee': '+ إضافة موظف',
  'New Company': 'شركة جديدة',
  'New Contact': 'جهة اتصال جديدة',
  'New Project': 'مشروع جديد',
  'New Follow-up': 'متابعة جديدة',
  'New Collection Payment': 'دفعة تحصيل جديدة',
  'Add Employee': 'إضافة موظف',
  ...
  'HVAC / MEP': 'تكييف / MEP',
  'Lead': 'عميل محتمل',
  'Proposal / Technical': 'عرض / فني',
  'Follow-up': 'متابعة',
  'Negotiation': 'تفاوض',
  'Won / Contract': 'تم الفوز / عقد',
  'Lost': 'خسارة',
  'Overdue follow-ups': 'متابعات متأخرة',
  'Due today': 'مستحق اليوم',
  'Loading CRM data...': 'جاري تحميل بيانات الـCRM...',
  'Unable to load CRM data': 'تعذر تحميل بيانات الـCRM',
  'No employees yet.': 'لا يوجد موظفون حتى الآن.',
  'English': 'الإنجليزية',
  'العربية': 'العربية',
};
...
function translateText(value, lang) {
  ...
  if (lang === 'en') return reverseTranslations[value] || value;
...
function translateDocument(lang) {
  ...
  document.querySelectorAll('input[placeholder], textarea[placeholder]').forEach(el => {
    const current = el.getAttribute('data-original-placeholder') || el.getAttribute('placeholder');
    if (!el.getAttribute('data-original-placeholder')) el.setAttribute('data-original-placeholder', current);
